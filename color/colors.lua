...
function COLOR.txtColor(c)
    ...
    if (c=='pink') then return ImGui.PushStyleColor(ImGuiCol.Text,0.9, 0.4, 0.4, 0.8) end
    ...
    if (c=='light blue2') then return ImGui.PushStyleColor(ImGuiCol.Text,0.2, 0.9, 0.9, 0.5) end
